...
- 인증 세부 규칙은 `.clinerules/authentication-rules.md`를 따른다.
- 인증 구조와 API 계약은 `docs/authentication-id-password-jwt.md`를 따른다.
- password, `passwordHash`, token, secret은 저장 목적 외 로그와 응답에 포함하지 않는다.
